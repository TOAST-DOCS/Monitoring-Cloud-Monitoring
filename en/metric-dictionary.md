...
## Metric Dictionary
- NHNCloud 내 서비스에 대한 모니터링을 위한 지표들을 정의한 목록 입니다
- 지표 사전을 통해 모니터링 대상 서비스의 지표를 확인하고, 이해할 수 있습니다.
- 또한 위젯 구성시 필요한 지표를 찾아서 사용할 수 있습니다. (콘솔 사용자 가이드 참고[링크](console-guide.md))
- 아래의 Metric List 에서 각 서비스별 지표 사전 목록을 확인할 수 있습니다.
