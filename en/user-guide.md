...
## Monitoring > Cloud Monitoring > Usage Scenarios { #monitoring-cloud-monitoring-usage-scenarios }
...
1. Click **Add Widgets** to go to the Add Widgets page.
![image](https://static.toastoven.net/prod_cloud_monitoring/cloud_monitoring_ug_02_02-1.png)
2. Enter a **Widget name** and select a **Graph type** and **Service**.
...
## Project Dashboard Visibility Settings { #project-dashboard-visibility-settings }
