...
- **수정 메뉴**를 클릭하면 **위젯 그룹 수정** 모달이 열립니다.
...
- **알림 사용 여부 토글**을 클릭해 알림을 활성화하거나 비활성화할 수 있습니다.
- **알림 상세 보기** 열의 보기를 클릭하면 **알림 상세 정보** 모달이 표시됩니다.
...
알림명, 알림 상태, 지표 항목, 발생 시간 필터를 사용해서 알림 발생 이력을 조회할 수 있습니다. 초기화를 누르면 검색 필터가 초기화됩니다.
