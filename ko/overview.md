<!-- pre-align:aligned sig=5c6d92c7cc59 -->

<a id="monitoring-cloud-monitoring-overview"></a>
## Monitoring > Cloud Monitoring > 개요 { #monitoring-cloud-monitoring-overview }
...
### Compute > Instance 서버 모니터링 { #compute-instance-server-monitoring }
...
### 지표 알림 조건 설정 { #notification-conditions }
...
### 알림 방법 선택: 이메일, SMS { #notification-methods-email-sms }
