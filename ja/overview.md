...
## Monitoring > Cloud Monitoring > 概要 { #monitoring-cloud-monitoring-overview }
...
### Compute > Instanceサーバーモニタリング { #compute-instance-server-monitoring }
...
### 指標通知条件設定 { #notification-conditions }
...
### 通知方法の選択：メール、SMS { #notification-methods-email-sms }
